...
#         print("thumb_border_color: ", self.thumbBorderColor, " ", self.thumbBorderWidth)
...
#          track_height, thumb_size, thumb_border_width, thumb_border_color, overlay_size) = style_key

#         print(thumb_border_color)
