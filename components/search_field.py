        ...
        return Column(
            ...
            children=[
                ...
                Container(
                    ...
                    margin=EdgeInsets.only(top=-26, left=238, right=12),
                    child=Row(
                        ...
                        children=[
                            (
                                ElevatedButton(
                                    ...
                                    child=Icon(key=Key("clear_icon"), icon=Icons.close_rounded, size=16),
                            ...
                            SizedBox(width=4),
                            Icon(key=Key("search_icon"), icon=Icons.search_rounded, size=16),
                        ]
                    )
                ),
            ]
